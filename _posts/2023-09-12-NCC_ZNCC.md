...
<!-- vscode-markdown-toc -->
* 1. [Stereo matching and depth compute](#Stereomatchinganddepthcompute)
	* 1.1. [Step](#Step)
* 2. [[标准差、方差、协方差、相关系数](https://zhuanlan.zhihu.com/p/266161140)](#https:zhuanlan.zhihu.comp266161140)
	* 2.1. [标准差](#)
	* 2.2. [方差](#-1)
	* 2.3. [协方差](#-1)
	* 2.4. [相关系数](#-1)
* 3. [NCC](#NCC)
	* 3.1. [简介](#-1)
	* 3.2. [**Formular**](#Formular)
* 4. [ZNCC](#ZNCC)
	* 4.1. [简介](#-1)
	* 4.2. [**Formular**](#Formular-1)
* 5. [[NCC与ZNCC的关系与向量理解[4]](https://en.wikipedia.org/wiki/Cross-correlation#Zero-normalized_cross-correlation9)](#NCCZNCC4https:en.wikipedia.orgwikiCross-correlationZero-normalized_cross-correlation9)
	* 5.1. [更优雅的公式](#-1)
		* 5.1.1. [NCC](#NCC-1)
		* 5.1.2. [ZNCC](#ZNCC-1)
	* 5.2. [以向量的角度](#-1)
* 6. [Implementation](#Implementation)
	...
	* 6.2. [NCC](#NCC-1)
	* 6.3. [ZNCC](#ZNCC-1)
* 7. [Result and groundtruth](#Resultandgroundtruth)
	* 7.1. [Datasets](#Datasets)
	* 7.2. [Output result](#Outputresult)
	* 7.3. [Ground truth](#Groundtruth)
...
##  1. <a name='Stereomatchinganddepthcompute'></a>Stereo matching and depth compute

###  1.1. <a name='Step'></a>Step
...
##  2. <a name='https:zhuanlan.zhihu.comp266161140'></a>[标准差、方差、协方差、相关系数](https://zhuanlan.zhihu.com/p/266161140)
...
###  3.2. <a name='Formular'></a>**Formular**
...
###  4.2. <a name='Formular-1'></a>**Formular**
...
##  5. <a name='NCCZNCC4https:en.wikipedia.orgwikiCross-correlationZero-normalized_cross-correlation9'></a>[NCC与ZNCC的关系与向量理解[4]](https://en.wikipedia.org/wiki/Cross-correlation#Zero-normalized_cross-correlation9)

###  5.1. <a name='-1'></a>更优雅的公式

####  5.1.1. <a name='NCC-1'></a>NCC
...
####  5.1.2. <a name='ZNCC-1'></a>ZNCC

cross-correlation of a template $t(x,y)$ with a subimage $f(x,y)$
Template(模板图像，待检测的图像，可以简单理解为右图，检测过程为在右图中寻找 )$t(x,y)$与子图像$f(x,y)$的互相关被称为ZNCC，公式如下所示
...
##  6. <a name='Implementation'></a>Implementation

###  6.1. <a name='-1'></a>**边缘像素如何处理?**
...
##  7. <a name='Resultandgroundtruth'></a>Result and groundtruth

###  7.1. <a name='Datasets'></a>Datasets
...
###  7.2. <a name='Outputresult'></a>Output result
...
![wid_25](https://raw.githubusercontent.com/2c984r83y/2c984r83y.github.io/main/images/wid_25.png)
###  7.3. <a name='Groundtruth'></a>Ground truth
![20230915172206](https://raw.githubusercontent.com/2c984r83y/2c984r83y.github.io/main/images/20230915172206.png)
##  8. <a name='Reference'></a>Reference
