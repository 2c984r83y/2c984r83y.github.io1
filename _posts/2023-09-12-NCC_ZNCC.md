...
$ NCC(p,d)=\frac{\sum_{(x,y)\in W_p}(I_1(x,y)-\overline{I}1(p_x,p_y))\bullet(I_2(x+d,y)-\overline{I}_2(p_x+d,p_y))}{\sqrt{\sum_{(x,y)\in{W}_p}\left(I_1(x,y)-\overline{I}_1(p_x,p_y)\right)^2\bullet\sum_{(x,y)\in{W}_p}\left(I_2(x+d,y)-\overline{I}_2(p_x+d,p_y)\right)^2}} $
