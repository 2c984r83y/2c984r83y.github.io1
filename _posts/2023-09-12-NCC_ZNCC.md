...
$NCC(p,d)=\frac{\textstyle \sum_{(x,y)\in W_p}^{}I_1(x,y)\cdot I_2(x+d,y) }{\sqrt{\sum_{(x,y)\in W_p}^{}I_1(x,y)^{2} \cdot \sum_{(x,y)\in W_p}^{}I_2(x,y)^{2}} }$
