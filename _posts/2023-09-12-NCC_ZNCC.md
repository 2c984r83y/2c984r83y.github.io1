...
ZNCC(Zero-normalized cross-correlation),相较NCC更鲁棒，因为ZNCC公式里减去了窗口内的均值，更能抵御光照的变化.[[4]](https://blog.csdn.net/fb_help/article/details/88543086)

> NCC的公式记成NCC的公式，导致了很多误解。其实NCC的公式应用的特别少，多数使用的是ZNCC的公式，只不过有些人将ZNCC与NCC的名称弄混淆，导致NCC这个名词的知名度很高，其实多数使用的公式却是ZNCC。[[4]](https://blog.csdn.net/fb_help/article/details/88543086)
...
[[3]Cross-correlation_Wikipedia](https://en.wikipedia.org/wiki/Cross-correlation)
[[4]NCC与ZNCC](https://blog.csdn.net/fb_help/article/details/88543086)
